...
//-----------------------------------------------------------------------------
	public void onCreate(Bundle savedInstanceState) {       
        ...
        imageFilename = this.getIntent().getStringExtra("edu.miami.c06804728.talkingpicturesfinal.image_file_name");
        description = this.getIntent().getStringExtra("edu.miami.c06804728.talkingpicturesfinal.description");
        rowId = this.getIntent().getLongExtra("edu.miami.c06804728.talkingpicturesfinal.rowId", -1);
        ...
        recordDirName = Environment.getExternalStorageDirectory().
        		getAbsolutePath() + "/Android/data/edu.miami.c06804728.talkingpicturesfinal/files";
...
//-----------------------------------------------------------------------------
	public void myClickHandler(View view) {
        ...
        case R.id.save_button:
	        ...
	        returnIntent.putExtra("edu.miami.c06804728.talkingpicturesfinal.description", description);
	        returnIntent.putExtra("edu.miami.c06804728.talkingpicturesfinal.rowId", rowId);
        	...
        	returnIntent.putExtra("edu.miami.c06804728.talkingpicturesfinal.recordFileName", recordFileName);
